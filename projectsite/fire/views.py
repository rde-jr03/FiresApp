...
from fire.models import Locations, FireStation, Incident, WeatherConditions, FireTruck
from fire.forms import Loc_Form, FireStationzForm, Incident_Form, Weather_condition, Firetruckform
